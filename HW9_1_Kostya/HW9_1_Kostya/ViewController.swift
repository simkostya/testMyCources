...
//  HW9_1_Kostya
//
//  Created by Kostya Simonchik on 9/30/21.
//
...
class ViewController: UIViewController {
    ...
    @objc func raceTimer() {
        ...
        if movingСircleView.frame.maxX < hippodromeView.frame.width && movingСircleView.frame.minY == 0  {
            ...
            movingСircleView.frame = CGRect(x: movingСircleView.frame.minX + 1,
                                             y: movingСircleView.frame.minY,
                                             width: movingСircleView.frame.width,
                                             height: movingСircleView.frame.height)
            ...
            movingСircleView.frame = CGRect(x: movingСircleView.frame.minX,
                                             y: movingСircleView.frame.minY + 1,
                                             width: movingСircleView.frame.width,
                                             height: movingСircleView.frame.height)
